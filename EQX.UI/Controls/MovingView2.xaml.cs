...
{
    /// <summary>
    /// Interaction logic for MovingView2.xaml
    /// </summary>
    public partial class MovingView2 : UserControl
    {
        ...
        public static readonly DependencyProperty MotionProperty =
            DependencyProperty.Register("Motion", typeof(IMotion), typeof(MovingView2), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty InterlockProperty =
            DependencyProperty.Register("Interlock", typeof(bool), typeof(MovingView2), new PropertyMetadata(true));
